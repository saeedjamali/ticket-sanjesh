...
export const NOTICE_CONFIG = {
  ...
  content: {
    title: "اطلاعیه : ",
    description: [
      "قابل توجه متقاضیان فرآیند انتقالات آموزشی درون استانی سال تحصیلی 1405-1404؛",
      "ثبت درخواست تجدیدنظر در این سامانه (rasad.razaviedu.ir) تا ساعت 24 روز یکشنبه مورخ 1404/06/09 تمدید شده و امکان پذیر می باشد.",
