...
export const NOTICE_CONFIG = {
  ...
  content: {
    title: "توجه : ",
    description: [
      "به اطلاع همکاران متقاضی تجدید نظر در فرایند انتقالات می‌رساند: امکان ثبت درخواست تجدید نظر انتقالات داخل استان از ساعت 18 امروز در این سامانه فعال خواهد شد",
