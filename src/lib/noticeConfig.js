...
export const NOTICE_CONFIG = {
  ...
  content: {
    title: "اطلاعیه : ",
    description: [
      "به اطلاع متقاضیان انتقال داخل استان می رساند، با توجه به تمدید انجام شده در مهلت ثبت تقاضا و ضرورت بررسی دقیق‌ درخواست همکاران مطابق ضوابط دستورالعمل ابلاغ شده، اعلام نتایج، متعاقباً از طریق همین سامانه اطلاع رسانی خواهد شد.",
