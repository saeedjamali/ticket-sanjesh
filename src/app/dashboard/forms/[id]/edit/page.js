...
// Import field types from create page
const FIELD_TYPES = {
  text: {
    label: "متن کوتاه",
    icon: "📝",
...
export default function EditFormPage() {
  ...
  useEffect(() => {
    if (!userLoading && !canEditForms) {
      router.push("/dashboard/forms");
    }
  }, [user, userLoading, canEditForms, router]);
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.success) {
          ...
          toast.error(data.message || "خطا در دریافت فرم");
          router.push("/dashboard/forms");
        }
      } else {
        toast.error("خطا در دریافت فرم");
        router.push("/dashboard/forms");
      }
    } catch (error) {
  ...
  const handleSubmit = async (status = "draft") => {
    ...
    try {
      ...
      if (data.success) {
        ...
        toast.error(data.message || "خطا در بروزرسانی فرم");
      }
    } catch (error) {
      console.error("Error updating form:", error);
      toast.error("خطا در بروزرسانی فرم");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="max-w-7xl mx-auto p-6">
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center">
          ...
          <h1 className="text-2xl font-bold text-gray-800">ویرایش فرم</h1>
        </div>
      ...
      {/* Form content - reuse components from create page */}
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3">
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            {showPreview ? (
              /* Form Preview - reuse from create page */
              <FormPreview formData={formData} />
            ) : (
              /* Form Builder - reuse from create page */
              <div>
...
// Reuse FieldEditor and FieldPreview components from create page
