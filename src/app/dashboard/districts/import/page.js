...
export default function ImportDistrictsPage() {
  ...
  const downloadTemplate = () => {
    window.location.href = "/api/districts/template";
  };

  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-800">افزودن گروهی مناطق</h1>
        <Link
          href="/dashboard/districts"
          className="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300"
        >
          بازگشت به مدیریت مناطق
        </Link>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="mb-6">
          <h2 className="text-lg font-semibold mb-2">
            راهنمای افزودن گروهی مناطق
          </h2>
          <p className="text-gray-600">
            برای افزودن گروهی مناطق، لطفا مراحل زیر را دنبال کنید:
          </p>
          <ol className="list-decimal list-inside mt-2 space-y-2 text-gray-600 pr-4">
            <li>فایل نمونه اکسل را دانلود کنید</li>
            <li>اطلاعات مناطق را در فایل وارد کنید</li>
          ...
          <div className="mt-6 border-t pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-green-50 border border-green-200 p-4 rounded-md">
                <p className="text-green-700 font-medium">مناطق ایجاد شده</p>
