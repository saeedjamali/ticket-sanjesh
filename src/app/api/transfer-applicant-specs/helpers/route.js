      ...
      medicalCommissionCodes: [
        {
          value: 1,
          label:
            "کد 1: انتقال به نزدیکترین محل مورد تقاضا بصورت دائم ضرورت دارد",
        },
        {
          value: 11,
          label:
            "کد 11: انتقال به نزدیکترین محل مورد تقاضا بصورت موقت ضرورت دارد",
        },
        {
          value: 2,
          label:
            "کد 2: انتقال به شهر مشهد (یکی از نواحی هفتگانه) بصورت موقت ضرورت دارد",
        },
        {
          value: 3,
          label: "کد 3: انتقال به شهرستان های مرکز قطب بصورت موقت ضرورت دارد",
        },
