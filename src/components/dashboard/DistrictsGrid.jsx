                                        ...
                                        <div className="pt-2 border-t border-gray-200 text-xs">
                                            <div className="grid grid-cols-2 gap-x-2 gap-y-1.5">
                                                ...
                                                <div className="flex items-center space-x-1 space-x-reverse">
                                                    ...
                                                    <span className="truncate">مدارس: <b>{toFarsiNumber(district.examCentersCount || 0)}</b></span>
                                                </div>
                                                <div className="flex items-center space-x-1 space-x-reverse">
                                                ...
                                                <div className="col-span-2 mt-1 border-t border-gray-100 pt-1">
                                                    ...
                                                    <div className="grid grid-cols-2 gap-1">
                                                        ...
                                                        <div className="flex items-center space-x-1 space-x-reverse">
                                                            ...
                                                            <div className="flex flex-col">
                                                                <span className="text-[8px] font-medium">کارشناس ارزیابی:</span>
                                                                <span className="text-[8px]">
                                                                    <span className="inline-flex items-center bg-blue-50 text-blue-700 text-[7px] px-1 rounded">
                                                                        جدید: <b className="ml-1">{toFarsiNumber(district.evalNewTicketsCount)}</b>
                                                                    </span>
                                                                    <span className="mx-0.5">|</span>
                                                                    <span className="inline-flex items-center bg-amber-50 text-amber-700 text-[7px] px-1 rounded">
                                                                        بررسی: <b className="ml-1">{toFarsiNumber(district.evalInProgressTicketsCount)}</b>
                                                                    </span>
                                                                </span>
                                                            </div>
                                                        </div>
